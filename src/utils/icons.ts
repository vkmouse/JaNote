...
import iconChevronLeft from "../assets/icons/new/icon-chevron-left.svg?raw";
import iconChevronRight from "../assets/icons/new/icon-chevron-right.svg?raw";
...
import iconBars3 from "../assets/icons/new/icon-bars-3.svg?raw";
